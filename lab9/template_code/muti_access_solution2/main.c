...
{
	FILE *fp_bin;
	pthread_t writer1, reader1, reader2;
						//writer2, writer3, writer4, writer5, writer6,
	//reader3,	reader4, reader5, reader6;
...
*/
	pthread_create(&reader1, NULL, reader1_fun, NULL);
	pthread_create(&reader2, NULL, reader2_fun, NULL);
/*
...
//	sleep(1);
	...
	{
//		puts("\nblock");
		retval = sbuffer_remove(buffer,&data, 5, 1);
//	puts("unblock");
...
//	sleep(1);
	...
	{
//		puts("\nblock");
		retval = sbuffer_remove(buffer,&data, 5, 0);
//	puts("unblock");
